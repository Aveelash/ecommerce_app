...
const Orders = ({ token }) => {
    ...
    const statusHandler = async (event, orderId) => {
        try {
            ...
            if (response.data.success) {
                await fetchAllOrders(); // Refresh the orders list after status update
            ...
            // Show appropriate error message from the error response or fallback to a default message
